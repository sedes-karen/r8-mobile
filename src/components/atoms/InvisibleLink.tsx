...
export function InvisibleLink<ParamList extends ReactNavigation.RootParamList>({ screen, params, action, href, children, style }: PropsWithChildren<{ style?: PressableProps['style'] } & LinkProps<ParamList>>) {
  const props = useLinkProps<ParamList>(
    ...
    // El editor muestra que ambos InvisibleLink y useLinkProps usan LinkProps<ParamList>, por lo que el cast es seguro
